...
Rectangle {
    ...
    /*!
       \qmlproperty bool StatusCard::disabledText
    ...
    */
    ...
    /*!
       \qmlproperty string StatusCard::primaryText
    ...
    */
    ...
    RowLayout {
        ...
        ColumnLayout {
            StatusBaseText {
                id: primaryText
                Layout.maximumWidth: statusCard.width - cardIcon.width - 24
                font.pixelSize: 15
